...
def test:
	moveObjects('Pink star');
	
def moveObjects(objName):
...
def directObject(objName):
	...
	uparrow = scene.objects['UpArrow'];
	downarrow = scene.objects['DownArrow'];
	leftarrow = scene.objects['LeftArrow'];
	rightarrow = scene.objects['RightArrow'];
